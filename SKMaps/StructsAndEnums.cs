...
namespace SKMaps
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	// SKDefinitions.cs -- as Generate by ObjectiveSharpie START
	...
	public enum SKMapSearchStatus : uint {
		NoError = 0,
		NoSearchComponent,
		NoMapInformation,
		issingSearchFile,
	...
	// SKDefinitions.cs -- as Generate by ObjectiveSharpie END
	////////////////////////////////////////////////////////////////////////////////////////////////////


	public enum SKProxyType {
		Network = 0,
		Socks5
	}
}
